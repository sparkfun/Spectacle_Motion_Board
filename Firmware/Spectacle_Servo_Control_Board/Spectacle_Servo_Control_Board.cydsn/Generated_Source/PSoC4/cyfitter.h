...
/* tickInt */
#define tickInt__INTC_CLR_EN_REG CYREG_CM0P_ICER
#define tickInt__INTC_CLR_PD_REG CYREG_CM0P_ICPR
#define tickInt__INTC_MASK 0x40000u
#define tickInt__INTC_NUMBER 18u
#define tickInt__INTC_PRIOR_MASK 0xC00000u
#define tickInt__INTC_PRIOR_NUM 3u
#define tickInt__INTC_PRIOR_REG CYREG_CM0P_IPR4
#define tickInt__INTC_SET_EN_REG CYREG_CM0P_ISER
#define tickInt__INTC_SET_PD_REG CYREG_CM0P_ISPR

/* SystemTimer_cy_m0s8_tcpwm_1 */
#define SystemTimer_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT4_CC
#define SystemTimer_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT4_CC_BUFF
#define SystemTimer_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT4_COUNTER
#define SystemTimer_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT4_CTRL
#define SystemTimer_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT4_INTR
#define SystemTimer_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT4_INTR_MASK
#define SystemTimer_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT4_INTR_MASKED
#define SystemTimer_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT4_INTR_SET
#define SystemTimer_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT4_PERIOD
#define SystemTimer_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT4_PERIOD_BUFF
#define SystemTimer_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT4_STATUS
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x10u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 4u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x1000u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 12u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x10000000u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 28u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x100000u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 20u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x10u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 4u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x10u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 4u
#define SystemTimer_cy_m0s8_tcpwm_1__TCPWM_NUMBER 4u
#define SystemTimer_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT4_TR_CTRL0
#define SystemTimer_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT4_TR_CTRL1
#define SystemTimer_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT4_TR_CTRL2
